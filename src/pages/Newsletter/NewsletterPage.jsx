...
const NewsletterPage = () => {
  ...
  useEffect(() => {
    ...
    if (activeTab === "featured") {
      ...
      result = result.filter((newsletter) =>
        bookmarked.includes(newsletter.id)
      );
    }
  ...
  useEffect(() => {
    ...
    setDisplayedNewsletters(
      filteredNewsletters.slice(indexOfFirstItem, indexOfLastItem)
    );
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Find the best newsletters curated by experts across various topics.
            Stay informed with quality content.
          </p>
        </div>
                  ...
                  <button
                    ...
                    className={`flex items-center px-3 py-2 rounded-full text-sm font-medium ${
                      selectedCategories.includes(category.id)
                        ? `${category.color} ring-2 ring-offset-2 ring-sky-500`
        ...
        <div className="mb-6 flex justify-between items-center">
          <p className="text-sm text-gray-600">
            ...
            <span className="font-medium">
              ...
              {Math.min(currentPage * itemsPerPage, filteredNewsletters.length)}
            </span>{" "}
            of <span className="font-medium">{filteredNewsletters.length}</span>{" "}
            results
          </p>
        ...
        {filteredNewsletters.length === 0 ? (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  >
                    <Bookmark
                      className={`h-5 w-5 ${
                        bookmarked.includes(newsletter.id) ? "fill-current" : ""
                      }`}
                    />
                  </button>
                  {newsletter.featured && (
                ...
                <div className="p-5">
                  <div className="flex justify-between items-start mb-2">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                        categories.find((c) => c.id === newsletter.category)
                          ?.color
                      }`}
                    >
                      {
                  ...
                  <div className="flex justify-between items-center text-sm text-gray-600 bg-white shadow-sm rounded-xl px-4 py-2">
                    ...
                    <Link to="/newsletters-details">
                      <button className="text-white bg-sky-500 hover:bg-sky-600 transition-all px-3 py-1.5 rounded-full text-xs font-semibold shadow-sm">
                        Read
                      </button>
                    </Link>
                  </div>
          ...
          <div className="space-y-4">
            {displayedNewsletters.map((newsletter) => (
              <div
                key={newsletter.id}
                className="group bg-white rounded-xl shadow-sm border border-gray-200 p-5 hover:shadow-md transition-shadow duration-300 flex flex-col md:flex-row"
              >
        ...
        {filteredNewsletters.length > 0 && totalPages > 1 && (
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-sm text-gray-600">
              ...
              of{" "}
              <span className="font-medium">{filteredNewsletters.length}</span>{" "}
              results
            </div>
